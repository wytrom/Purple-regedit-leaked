...
namespace KeyAuth
{
    public class api
    {
        ...
        public api(string name, string ownerid, string secret, string version)
        {
            ...
            {
                MessageBox.Show("Configurações do KeyAuth não configurado. Verifique o Program.cs");
                Environment.Exit(0);
            }
        ...
        public void init()
        {
            ...
            {
                MessageBox.Show("Configurações do KeyAuth invalida.");
                Environment.Exit(0);
            }
        ...
        public void register(string username, string pass, string key)
        {
            if (!initzalized)
            {
                MessageBox.Show("Inicie a Aplicação primeiro");
                Environment.Exit(0);
            }
